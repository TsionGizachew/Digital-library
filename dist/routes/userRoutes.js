...
router.get('/', (0, middleware_1.authorize)(types_1.UserRole.ADMIN), middleware_1.validatePaginationQuery, userController.getAllUsers);
router.get('/search', (0, middleware_1.authorize)(types_1.UserRole.ADMIN), middleware_1.validatePaginationQuery, userController.searchUsers);
router.get('/stats', (0, middleware_1.authorize)(types_1.UserRole.ADMIN), userController.getUserStats);
