...
router.get('/stats', (0, middleware_1.authorize)(types_1.UserRole.ADMIN), bookingController.getBookingStats);
router.get('/pending', (0, middleware_1.authorize)(types_1.UserRole.ADMIN), middleware_1.validatePaginationQuery, bookingController.getPendingBookings);
router.get('/overdue', (0, middleware_1.authorize)(types_1.UserRole.ADMIN), middleware_1.validatePaginationQuery, bookingController.getOverdueBookings);
...
router.get('/', (0, middleware_1.authorize)(types_1.UserRole.ADMIN), middleware_1.validatePaginationQuery, bookingController.getAllBookings);
